<script lang="ts">
	import NakamotoBackground from '$lib/assets/NakamotoBackground.svelte';
	import NakamotoShield from '$lib/assets/NakamotoShield.svelte';
...
{#if link.address}
	<div class="mt-6 sm:flex sm:items-center sm:justify-between">
		<h1 class="text-2xl text-[#0A0A0B] sm:-mx-4 sm:text-4xl">
			<a href={link.address} class="rounded-md px-4 py-2" target="_blank">
				{@html link.name}
				<svg
					class="inline"
					width="40"
				...
				>
					<path
						d="M34.8958 27.6042L37.5 25C40.9518 21.5482 40.9518 15.9518 37.5 12.5C34.0482 9.04822 28.4518 9.04822 25 12.5L22.3958 15.1042"
						stroke="#0A0A0B"
						stroke-width="3.125"
					...
					/>
					<path
						d="M15.1042 22.3958L12.5 25C9.04822 28.4518 9.04822 34.0482 12.5 37.5C15.9518 40.9518 21.5482 40.9518 25 37.5L27.6042 34.8958"
						stroke="#0A0A0B"
						stroke-width="3.125"
						stroke-linecap="round"
						stroke-linejoin="round"
					/>
					<path
						d="M29.6875 20.3125L20.3125 29.6875"
						stroke="#0A0A0B"
						stroke-width="3.125"
						stroke-linecap="round"
						stroke-linejoin="round"
