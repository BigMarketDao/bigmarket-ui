...
<div class="col-span-1 cursor-pointer items-stretch rounded-lg border border-gray-300 p-5 hover:bg-gray-1000 hover:text-white" on:focus on:mouseover={() => selected} role="button" tabindex="0">
	...
	<div class="text-secondary-500 self-stretch text-center font-mono text-sm">
		{#if selected === 0}
			<div class="mt-8 flex w-full justify-center">
				<button on:click={() => gotoLink()} class="rounded bg-bitcoinorange px-6 py-2 font-semibold text-black transition duration-200 hover:bg-primary-600">
