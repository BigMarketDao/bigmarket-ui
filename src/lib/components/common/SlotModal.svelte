...
<div class="fixed inset-0 z-50 flex items-center justify-center bg-gray-1000 backdrop-blur-sm transition-opacity duration-300" style="@apply animate-fade-in" on:click={closeModal}>
