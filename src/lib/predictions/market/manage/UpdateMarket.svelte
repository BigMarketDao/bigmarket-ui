<script lang="ts">
	...
	const getSignature = async () => {
		...
		pollMessage = opinionPollToTupleCV(
			market.unhashedData.createdAt,
			market.unhashedData.name,
			market.unhashedData.proposer
		);
						...
						<div class="flex flex-col gap-y-4">
							...
							<div class="bottom-1 mb-2 flex w-full flex-col justify-start">
								<label for="project-name" class=""
									>logo - enter a url to an image/pfp file you want to display for this market</label
								>
								<input
									id="logo-name"
									class="rounded-lg border-gray-800 p-2 text-black"
									bind:value={market.unhashedData.logo}
									type="text"
							...
							{#if market.unhashedData.logo}
								<div class="bottom-1 mb-2 flex w-full flex-col justify-start">
									<img
										...
										alt="logo representing prediction market"
									/>
								</div>
							{/if}
							<div class="">
								...
								<div class="bottom-1 mb-2 flex w-full flex-col justify-start">
									...
									<input
										...
										class="rounded-lg border-gray-800 p-2 text-black"
										bind:value={market.unhashedData.startBurnHeight}
										type="text"
								...
								<div class="bottom-1 mb-2 flex w-full flex-col justify-start">
									...
									<input
										...
										class="rounded-lg border-gray-800 p-2 text-black"
										bind:value={market.unhashedData.endBurnHeight}
										type="text"
							...
							<div class="">
								...
								<div class="bottom-1 mb-2 flex w-full flex-col justify-start">
									...
									<input
										id="project-handle"
										class="rounded-lg border-gray-800 p-2 text-black"
										bind:value={market.unhashedData.social.twitter.projectHandle}
										type="text"
								...
								<div class="bottom-1 mb-2 flex w-full flex-col justify-start">
									...
									<input
										id="project-serverId"
										class="rounded-lg border-gray-800 p-2 text-black"
										bind:value={market.unhashedData.social.discord.serverId}
										type="text"
								...
								<div class="bottom-1 mb-2 flex w-full flex-col justify-start">
									...
									<input
										id="project-website"
										class="rounded-lg border-gray-800 p-2 text-black"
										bind:value={market.unhashedData.social.website.url}
										type="text"
