<script lang="ts">
	...
	export let logo: string = placeholderImage;
...
<div class=""><img src={logo || placeholderImage} alt="Market Logo" on:error={handleError} class="max-h-[150px] max-w-[150px] place-self-center rounded-full object-cover" /></div>
